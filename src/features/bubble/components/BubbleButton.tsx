...
export const BubbleButton = (props: Props) => {
  return (
    <div
      class={`fixed hover:scale-110 active:scale-95 transition-transform duration-200 flex justify-center items-center animate-fade-in w-80 h-32 cursor-pointer`}
      style={{
    ...
    >
      <div
        class={
          props.isBotOpened
            ? 'hidden'
            : 'md:flex justify-center items-center absolute top-4 left-5 shadow-md rounded-t-md rounded-bl-md animate-fade-in text-white w-64 mr-2 p-2 sm: hidden'
        }
        style={{
